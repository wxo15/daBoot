...
namespace daBoot.Migrations
{
    ...
    [Migration("20210923160330_Notifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("daBoot.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("daBoot.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<string>("GetAction")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("daBoot.Models.Comment", b =>
                {
                    b.HasOne("daBoot.Models.Ticket", "Ticket")
                        .WithMany("Comments")
                        .HasForeignKey("TicketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("daBoot.Models.Account", "CommentUser")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("daBoot.Models.Notification", b =>
                {
                    b.HasOne("daBoot.Models.Account", "NotificationUser")
